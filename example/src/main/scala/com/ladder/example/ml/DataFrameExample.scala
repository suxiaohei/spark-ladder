...
package com.ladder.example.ml

import java.io.{File, IOException}
import java.util.UUID

import com.ladder.example.mllib.AbstractParams
...
object DataFrameExample {
		...
		def run(params: Params): Unit = {
				...
				def root: String = System.getProperty("java.io.tmpdir")

				def namePrefix: String = "spark"

				val tmpDir = createDirectory(root, namePrefix)
